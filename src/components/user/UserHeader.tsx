  ...
  return (
    <header className="h-16 px-6 bg-white border-b border-gray-100 flex items-center justify-between sticky top-0 z-30">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" className="md:hidden text-gray-500 hover:text-gray-700">
          <Menu size={20} />
        </Button>
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" className="text-gray-400 hover:text-gray-600 transition-colors relative">
          <Bell size={20} />
