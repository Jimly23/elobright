...
import { BookOpen, Headphones, PenTool, Timer } from 'lucide-react';
    ...
    <div className='flex justify-center items-center min-h-screen'>
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-[40px] shadow-2xl shadow-blue-200/50 overflow-hidden mx-6">
        ...
        <div className="p-10 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-extrabold text-slate-800 mb-1">Speaking</h2>
          ...
          <Link href="/english-test/toefl/speaking/exam" className='w-full'>
            <button
